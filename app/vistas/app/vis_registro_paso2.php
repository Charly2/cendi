                ...
                <div class="my-3">
                    ...
                    <div class="row rowjc">
                        <div class="col-md-4">
                            <div class="tile">
                                <p class="mb-0">
                                    Cerrada Merida Mz 2 Lt 1. <br>
                                    Colonia: Miguel de la Madrid. <br>
                                    CP: 09698, Del: Iztapalapa. <br>
                                    CDMX, México.
                                </p>
                                <a class="btn btn-primary btn-large btn-block" href="#" >Utilizar dirección</a>
                            </div>
                        </div>
                    </div>
                    <div class="row rowjc">
